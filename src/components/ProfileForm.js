...
import { RiZoomInFill, RiCloseCircleFill } from "react-icons/ri";
    ...
    <>
      ...
      >
        <Avatar
          ...
          className={`text-6xl relative w-fit mx-auto select-none ${
          ...
          rounded
          onClick={(e) => {
            formInfo.avatar !== false && setShowLightbox(true);
          }}
        >
          <RiCloseCircleFill
            className="absolute top-0 right-0 text-2xl text-red-600 cursor-pointer hover:scale-110 hover:rotate-90 active:scale-125 active:text-red-500 transition-transform"
            onClick={(e) => {
              e.stopPropagation();
